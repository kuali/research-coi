  ...
  return (
    <svg className={props.className} version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 42 42" enableBackground="new 0 0 42 42" role="img" aria-labelledby="title">
      ...
      <g>
        ...
        <path
          fill={props.color}
          d="M21,6.8C13.2,6.8,6.8,13.2,6.8,21S13.2,35.2,21,35.2c2.2,0,4.4-0.5,6.3-1.5c2.7-1.3,4.9-3.5,6.3-6.1 c1-2,1.6-4.2,1.6-6.6C35.2,13.2,28.8,6.8,21,6.8z M32.5,26.4c-1.3,2.7-3.5,4.9-6.3,6.1c-1.6,0.7-3.3,1.1-5.2,1.1 C14,33.7,8.3,28,8.3,21S14,8.3,21,8.3S33.7,14,33.7,21C33.7,23,33.3,24.8,32.5,26.4z"
        />
      </g>
    </svg>
  );
