...
export class InstructionIcon extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    return (
      <svg style={this.props.style} enable-background="new 0 0 100 100" viewBox="0 0 100 125" y="0px" x="0px" version="1.0">
