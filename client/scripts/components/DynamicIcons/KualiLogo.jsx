...
export class KualiLogo extends React.Component {
  ...
  render() {
    return (
      <svg style={this.props.style} version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 152.3 153.1" enable-background="new 0 0 152.3 153.1" role="img" aria-labelledby="title">
        <title id="title">Kuali Logo</title>
        <g>
