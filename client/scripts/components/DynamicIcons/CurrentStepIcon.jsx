  ...
  render() {
    return (
      <svg style={this.props.style} version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 42 42" enable-background="new 0 0 42 42" role="img" aria-labelledby="title">
        ...
        <g>
          <circle fill={this.props.style.color} cx="21" cy="20.9" r="6.1"/>
          ...
          <path fill={this.props.style.color} d="M21,6.8C13.2,6.8,6.8,13.2,6.8,21S13.2,35.2,21,35.2c2.2,0,4.4-0.5,6.3-1.5c2.7-1.3,4.9-3.5,6.3-6.1
