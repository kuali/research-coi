  ...
  const steps = [
    {
      ...
      link: '/coi/new/config/general',
      active: true
    },
    {
      label: 'Disclosure Requirements',
      link: '/coi/new/config/disclosure-requirements'
    },
    {
      label: 'Screening Questionnaire',
      link: '/coi/new/config/questionnaire'
    },
    {
      label: 'Financial Entities Questionnaire',
      link: '/coi/new/config/entities'
    },
    {
      label: 'Relationship Matrix',
      link: '/coi/new/config/relationship'
    },
    {
      label: 'Project Declarations',
      link: '/coi/new/config/declarations'
    },
    {
      label: 'Customize Certification',
      link: '/coi/new/config/certification'
    }
  ];
    ...
    steps.splice(2,0,
      {
        ...
        link: '/coi/new/config/customize-notifications'
      }
    );
  }
